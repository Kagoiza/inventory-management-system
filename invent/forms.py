...
class InventoryItemForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['name', 'serial_number', 'category', 'condition', 'status', 'expiration_date', 'quantity_total', 'quantity_issued', 'quantity_returned']
        widgets = {
            'name': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Item Name'}),
            'serial_number': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Serial Number'}), # Added widget for serial_number
            'category': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Category'}),
            'condition': forms.Select(attrs={'class': 'form-select'}, choices=InventoryItem.CONDITION_CHOICES), # Added widget for condition
